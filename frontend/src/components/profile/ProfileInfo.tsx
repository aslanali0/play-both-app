...
const ProfileInfo = () => {
  ...
  return (
    <div className="w-full home-element shadow-xl overflow-hidden transition-all hover:shadow-2xl p-6 rounded-t-2xl flex flex-col items-center">
      ...
      {isEditing ? (
        <form onSubmit={handleUpdate} className="w-full flex flex-col gap-4">
          ...
          />
          <input
            className="w-full bg-indigo-500 text-white font-bold py-2 rounded-lg cursor-pointer hover:bg-indigo-600 transition-colors"
            type="submit"
            value="Update"
          />
        </form>
