...
const LoginPage = () => {
  ...
  return (
    <div className='shadow-lg shadow-blue-500/50 w-96 h-auto bg-linear-to-bl from-indigo-900 to-sky-800 rounded-lg shadow-lg shadow-black/30 p-6 m-auto mt-20'>
      <form className='flex flex-col' onSubmit={handleLogin}>
        ...
        <div className='flex items-center mt-4'>
          ...
          <span className='text-center w-20 text-white'>or</span>

          <Link to="/signup" className='!text-inherit text-center mr-auto w-30 bg-green-200 shadow-md shadow-green-500/20 hover:bg-green-500 transition-colors rounded-lg font-semibold p-3 cursor-pointer'>Sign up</Link>
        </div>
      </form >
