    ...
    <div className='shadow-lg shadow-blue-500/50 w-96 h-auto bg-linear-to-bl from-indigo-900 to-sky-800 rounded-lg shadow-lg shadow-black/30 p-6 m-auto mt-20'>
      <form className='flex flex-col' onSubmit={handleSignup}>
        ...
        <div className='flex items-center mt-4'>
          <Link to="/login" className='!text-inherit text-center mr-auto w-30 bg-blue-400 shadow-md shadow-blue-500/20 hover:bg-blue-500 transition-colors rounded-lg font-semibold p-3 cursor-pointer'>Login</Link>
          <span className='w-20 text-white text-center'>or</span>
