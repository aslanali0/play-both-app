    ...
    <div className="text-white m-0 w-screen  min-h-screen flex flex-col bg-slate-950 ">
      ...
      <div key={location.pathname} className='animate-slide-up'>
          <Routes>
            ...
            <Route path='/profile' element={<ProtectedRoute><PublicProfilePage /></ProtectedRoute>}></Route>
            <Route path='/profile/me' element={<ProtectedRoute><ProfilePage /></ProtectedRoute>}></Route>
